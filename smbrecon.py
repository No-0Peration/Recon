...
VULNSCAN = "nmap -sV -Pn -vv -p445 --script=smb-vuln-conficker.nse,smb-vuln-cve2009-3103.nse,smb-vuln-ms06-025.nse,smb-vuln-ms07-029.nse,smb-vuln-ms08-067.nse,smb-vuln-ms10-054.nse,smb-vuln-ms10-061.nse --script-args=unsafe=1 -oN './results/%s_smb.nmap' %s" % (ip, ip)
